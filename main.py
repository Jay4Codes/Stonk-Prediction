...
st.sidebar.image("./static/images/img1.png")
...
if rad1 == "Home": 
    ...
    selected_stock = st.text_input('Enter Your Desired Ticker')
    stocks = ('AURIONPRO.NS', 'GOOG', 'AAPL', 'MSFT', 'GME', 'EMKAY.NS', 'TCS.NS', 'WIPRO.NS', 'RELIANCE.NS')
    selected_stock = st.selectbox('Popular Tickers', stocks)
